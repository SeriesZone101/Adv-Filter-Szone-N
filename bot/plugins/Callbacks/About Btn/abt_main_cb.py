...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Bot Support:</i></b> <a href="https://t.me/DeepakV1111_bot">Joey</a>\n"""
    text+="""\n<b><i>Source Code:</i></b> <a href="https://t.me/sourcecodeveno">Source</a>"""

    buttons = [
        [
            InlineKeyboardButton
                (
                    "My Dev ⚡", url="https://t.me/DeepakV111"
                ),
